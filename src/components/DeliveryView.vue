<template>
  <div class="delivery">
    <div class="title">
      <h4 class="title-desktop">OUR DELIVERY - PICK UP</h4>
    ...
    <div class="delivery__apps">
      <div class="cards">
        ...
        <a
          target="_blank"
          href="https://m.yelp.com/biz/itacali-deliciously-mexican-oakland"
          ><img src="../assets/yeip.png" alt="Yelp"
        /></a>
      </div>
    </div>
      ...
      <div class="text">
        ...
        <div class="items">
          ...
          <div class="item">
            ...
            <span>&nbsp; 2353 E 12th St, Oakland, CA 94601, United States</span>
          </div>
        </div>
      </div>
      <div class="map">
  ...
  <div class="footer">
    ...
    <div class="line"></div>
    <p>Mangan 2021©, All rights reserved.</p>
  </div>
</template>
